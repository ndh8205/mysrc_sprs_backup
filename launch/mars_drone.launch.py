...
def generate_launch_description():
    ...
    world_file = os.path.join(orbit_sim_path, 'worlds', 'mars_drone.world')
    ...
    imu_bridge = Node(
        ...
        name='imu_bridge',
        arguments=[
            '/world/mars_drone_world/model/x500_mars/link/base_link/sensor/imu_sensor/imu@sensor_msgs/msg/Imu@gz.msgs.IMU',
        ],
        output='screen'
    )
