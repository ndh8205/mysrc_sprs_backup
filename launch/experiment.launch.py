...
def generate_launch_description():
    ...
    world_file = os.path.join(orbit_sim_path, 'worlds', 'experiment.world')
    ...
    name='wrench_bridge',
    arguments=[
        '/world/experiment_world/wrench@ros_gz_interfaces/msg/EntityWrench@gz.msgs.EntityWrench'
    ],
    output='screen'
    )
    ...
    force_torque_controller_node = Node(
        package='orbit_sim',
        executable='force_torque_controller', # 파일명 변경
        name='force_torque_controller',
        output='screen'
    )
