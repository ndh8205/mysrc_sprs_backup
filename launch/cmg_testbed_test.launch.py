#!/usr/bin/env python3
"""
CMG Testbed — automated scenario test + CSV logging
- Gazebo DART simulation + ROS-GZ bridges + scenario node
- GUI 없이 자동 시나리오 실행 후 CSV 저장
"""
...
def generate_launch_description():
    ...
    # 6. Scenario runner (replaces GUI commander)
    scenario_node = Node(
        package='orbit_sim',
        executable='cmg_testbed_scenario',
        name='cmg_testbed_scenario',
        output='screen',
    )
